...
public interface ITTSEngine {
     ...
     * @param index
     *          Positive int value to be reported via IVoiceEventListener when start speaking text.
     *          TTS engine should also report -1 when completed. 
     *          index event should not reported when negative index is specified
     */
     ...
     * @return
     *      true when TTS engine is available
     *      false when TTS engine is not available 
     */
