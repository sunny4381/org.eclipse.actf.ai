...
public interface IVoice {
     ...
     * @return Speeking speed in range between 0 and 100
     * @see setSpeed
     */
    public int getSpeed();
     ...
     * Please note: This function is provided for special voice application which requires precise control of 
     * TTS engine features. Use of low-level interface is generally not recommended.
     * @return ITTSEngine
     */
